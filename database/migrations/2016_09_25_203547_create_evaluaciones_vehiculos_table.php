...
class CreateEvaluacionesVehiculosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evaluaciones_vehiculos', function(Blueprint $table)
        {
            $table->increments('id');
    ...
    {
        Schema::drop('evaluaciones_vehiculos');
    }
}
