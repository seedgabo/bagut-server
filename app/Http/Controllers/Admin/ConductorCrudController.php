...
class ConductorCrudController extends CrudController {
	...
	public function __construct() {
		...
		*/ 
        ...
        $this->crud->setModel("App\Models\Conductor");
  ...
  public function store(StoreRequest $request)
  {
    ...
    $conductor = \App\Models\Conductor::create($data);
  ...
  {
    $conductor = \App\Models\Conductor::find($request->id);
    $data = $request->except("_method","_token");
