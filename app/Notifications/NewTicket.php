...
class NewTicket extends Notification  implements ShouldQueue 
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line('A usted se le ha asignado un nuevo ' . Lang::choice('literales.ticket',1))
                    ->action('ver', url('/ticket/ver/'.$this->ticket->id))
                    ->line('Titulo:'. $this->ticket->titulo )
                    ->line('Categoria: ' .$this->ticket->categoria->nombre)
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'titulo' => "Nuevo ". Lang::choice('literales.ticket', 1) ." asignado: ". $this->ticket->titulo,
