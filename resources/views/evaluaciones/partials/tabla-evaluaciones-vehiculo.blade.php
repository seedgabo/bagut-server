    <div class="box box-default hover">
        <div class="box-header">
            <h5 class="text-primary">Evaluaciones A {{ $vehiculo->full_name }}</h5>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-hover table-condensed datatable">
                    ...
                    <tbody>
                    <?php $i=1 ?>
                    @forelse ($vehiculo->evaluaciones()->orderBy('fecha_evaluacion')->get() as $eval)
                        <tr>
                            <td>{{$i++}}</td>
                            ...
                            <td><a class="btn btn-sm" href="{{url('admin/ver-evaluacion-vehiculo/' . $eval->id)}}">Ver</a></td>
                        </tr>
                    @empty
                    <tr>
            ...
            <a class="btn btn-primary" href="{{url('admin/evaluaciones-vehiculos/create?vehiculo_id='. $vehiculo->id)}}">Agregar Evaluación</a>
            </div>
        </div>
    </div>
    <!-- Datatable -->
