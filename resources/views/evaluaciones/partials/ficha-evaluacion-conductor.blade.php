<div class="box box-default hover">
    <div class="box-header">
        <h5 class="text-primary">
           Evaluación {{$evaluacion->evaluacion->nombre}} a <small><a href="{{url('admin/ver-conductor/'. $conductor->id)}}">{{$conductor->full_name}} </a></small></h5>
        <div class="box-tools pull-right">
            <a href="{{url('admin/evaluaciones-conductores/'. $evaluacion->id .'/edit')}}"><i class="fa fa-edit"></i> Editar</a>
